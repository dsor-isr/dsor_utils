 ...
 * Github: https://github.com/jimmyberg/CircularDelay/tree/master
 * Brief: Circular delay software library. Here data can be stored and retrieved is a
 * LiFo manner.
 * License: GNU @copyright  GPL V3
 *
